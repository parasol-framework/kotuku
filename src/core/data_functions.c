...
FDEF argsAnalysePath[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Type", FD_INT|FD_RESULT }, { 0, 0 } };
...
FDEF argsCompareFilePaths[] = { { "Error", FD_INT|FD_ERROR }, { "PathA", FD_CPP|FD_STR }, { "PathB", FD_CPP|FD_STR }, { 0, 0 } };
FDEF argsCopyFile[] = { { "Error", FD_INT|FD_ERROR }, { "Source", FD_CPP|FD_STR }, { "Dest", FD_CPP|FD_STR }, { "Callback", FD_FUNCTIONPTR }, { 0, 0 } };
FDEF argsCreateFolder[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Permissions", FD_INT }, { 0, 0 } };
FDEF argsCreateLink[] = { { "Error", FD_INT|FD_ERROR }, { "From", FD_CPP|FD_STR }, { "To", FD_CPP|FD_STR }, { 0, 0 } };
FDEF argsCurrentContext[] = { { "Object", FD_OBJECTPTR }, { 0, 0 } };
FDEF argsCurrentTask[] = { { "Object", FD_OBJECTPTR }, { 0, 0 } };
FDEF argsDeleteFile[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Callback", FD_FUNCTIONPTR }, { 0, 0 } };
FDEF argsDeleteVolume[] = { { "Error", FD_INT|FD_ERROR }, { "Name", FD_CPP|FD_STR }, { 0, 0 } };
...
FDEF argsFindObject[] = { { "Error", FD_INT|FD_ERROR }, { "Name", FD_CPP|FD_STR }, { "ClassID", FD_INT|FD_UNSIGNED }, { "ObjectID", FD_OBJECTID|FD_RESULT }, { 0, 0 } };
...
FDEF argsGetActionMsg[] = { { "Message", FD_PTR|FD_STRUCT|FD_RESOURCE }, { "Action", FD_INT }, { 0, 0 } };
...
FDEF argsGetEventID[] = { { "Result", FD_INT64 }, { "Group", FD_INT }, { "SubGroup", FD_CPP|FD_STR }, { "Event", FD_CPP|FD_STR }, { 0, 0 } };
...
FDEF argsIdentifyFile[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Filter", FD_INT|FD_UNSIGNED }, { "Class", FD_INT|FD_UNSIGNED|FD_RESULT }, { "SubClass", FD_INT|FD_UNSIGNED|FD_RESULT }, { 0, 0 } };
...
FDEF argsLoadFile[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Flags", FD_INT }, { "CacheFile:Cache", FD_PTR|FD_STRUCT|FD_RESOURCE|FD_RESULT }, { 0, 0 } };
...
FDEF argsMoveFile[] = { { "Error", FD_INT|FD_ERROR }, { "Source", FD_CPP|FD_STR }, { "Dest", FD_CPP|FD_STR }, { "Callback", FD_FUNCTIONPTR }, { 0, 0 } };
...
FDEF argsOpenDir[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Flags", FD_INT }, { "DirInfo:Info", FD_PTR|FD_STRUCT|FD_RESOURCE|FD_ALLOC|FD_RESULT }, { 0, 0 } };
...
FDEF argsReadFileToBuffer[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_CPP|FD_STR }, { "Buffer", FD_BUFFER|FD_PTR|FD_MUTABLE }, { "BufferSize", FD_INT|FD_BUFSIZE }, { "Result", FD_INT|FD_RESULT }, { 0, 0 } };
FDEF argsReadInfoTag[] = { { "Error", FD_INT|FD_ERROR }, { "FileInfo:Info", FD_PTR|FD_STRUCT }, { "Name", FD_CPP|FD_STR }, { "Value", FD_STR|FD_RESULT }, { 0, 0 } };
...
FDEF argsResolveClassName[] = { { "Result", FD_INT|FD_UNSIGNED }, { "Name", FD_CPP|FD_STR }, { 0, 0 } };
...
FDEF argsSetName[] = { { "Error", FD_INT|FD_ERROR }, { "Object", FD_OBJECTPTR }, { "Name", FD_CPP|FD_STR }, { 0, 0 } };
...
FDEF argsSetResourcePath[] = { { "Error", FD_INT|FD_ERROR }, { "PathType", FD_INT }, { "Path", FD_CPP|FD_STR }, { 0, 0 } };
FDEF argsSetVolume[] = { { "Error", FD_INT|FD_ERROR }, { "Name", FD_CPP|FD_STR }, { "Path", FD_CPP|FD_STR }, { "Icon", FD_CPP|FD_STR }, { "Label", FD_CPP|FD_STR }, { "Device", FD_CPP|FD_STR }, { "Flags", FD_INT }, { 0, 0 } };
...
FDEF argsVirtualVolume[] = { { "Error", FD_INT|FD_ERROR }, { "Name", FD_CPP|FD_STR }, { "Tags", FD_TAGS }, { 0, 0 } };
