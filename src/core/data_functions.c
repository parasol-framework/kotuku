...
FDEF argsReadFileToBuffer[] = { { "Error", FD_INT|FD_ERROR }, { "Path", FD_STR }, { "Buffer", FD_BUFFER|FD_PTR|FD_MUTABLE }, { "BufferSize", FD_INT|FD_BUFSIZE }, { "Result", FD_INT|FD_RESULT }, { 0, 0 } };
