...
Negative indices count backwards from the end: `-1` is the last element, `-2` the second-to-last.  The exclusive/inclusive semantics of the range operator are preserved with negative indices.  `..` remains exclusive and `pass:[...]` remains inclusive.

[source,tiri]
----
s = 'Hello, World!'
s[{-6...-1}]    -- 'World!'  (inclusive)
s[{-6..-1}]     -- 'World'   (exclusive)

t = {10, 20, 30, 40, 50}
t[{-2...-1}]    -- {40, 50}  (inclusive)
t[{-2..-1}]     -- {40}      (exclusive)
t[{-3...4}]     -- {30, 40, 50}
----
