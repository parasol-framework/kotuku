...
=== Type Annotations
indexterm:[type annotations]
indexterm:[variables, type annotations]
...
indexterm:[to-be-closed variables]
indexterm:[close variables]
