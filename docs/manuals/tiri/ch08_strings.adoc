...
indexterm:[strings, interpolation]
...
indexterm:[strings, searching]
indexterm:[strings, extraction]
...
[[sec-encoding]]
=== Encoding
indexterm:[strings, encoding]
indexterm:[XML escaping]
...
=== Slicing with Ranges
indexterm:[strings, slicing]
indexterm:[ranges, string slicing]
