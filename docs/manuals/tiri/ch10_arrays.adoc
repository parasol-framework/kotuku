...
[%breakable]
=== Element Access
indexterm:[arrays, element access]
...
=== Search & Query
indexterm:[arrays, searching]
indexterm:[arrays, querying]
...
=== Copying & Slicing
indexterm:[arrays, copying]
indexterm:[arrays, slicing]
...
=== Functional Methods
indexterm:[arrays, functional methods]
