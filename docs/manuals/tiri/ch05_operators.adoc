...
indexterm:[operators, arithmetic]
...
indexterm:[operators, comparison]
...
indexterm:[operators, flag testing]
...
indexterm:[operators, string concatenation]
...
=== Compound Assignment
indexterm:[operators, compound assignment]
...
=== Postfix Increment
indexterm:[operators, postfix increment]
...
indexterm:[operators, conditional]
...
[[sec-safe-navigation]]
=== Safe Navigation
indexterm:[operators, safe navigation]
...
=== Membership Operator
indexterm:[operators, membership]
...
=== Operator Precedence
indexterm:[operators, precedence]
