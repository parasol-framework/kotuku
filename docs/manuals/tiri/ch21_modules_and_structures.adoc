...
indexterm:[include directive] The `include` directive loads the interface definitions (constants, structures, and class definitions) for one or more Kōtuku modules.  It accepts a comma-separated list of module names as string arguments:
...
[cols="1,1,2a",options="header",stripes=even]
|===
|From |To |Behaviour
...
[cols="1,2a,1",options="header",stripes=even]
|===
