...
indexterm:[mathematics, arithmetic]
...
[[sec-trigonometry]]
=== Trigonometry
indexterm:[mathematics, trigonometry]
...
indexterm:[mathematics, logarithms]
indexterm:[mathematics, exponentials]
...
[[sec-conversion]]
=== Conversion
indexterm:[mathematics, conversion]
...
=== Comparison & Clamping
indexterm:[mathematics, clamping]
...
[[sec-math-constants]]
=== Constants
indexterm:[mathematics, constants]
